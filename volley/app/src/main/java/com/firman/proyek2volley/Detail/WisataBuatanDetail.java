...
public class WisataBuatanDetail extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strImage = getIntent().getExtras().getString("wisata_image");
        String strTitle = getIntent().getExtras().getString("wisata_title");
        String strDesc = getIntent().getExtras().getString("wisata_desc");
