...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginUser = (EditText) findViewById(R.id.etName);
        loginPassword = (EditText) findViewById(R.id.etPassword);
        register = (TextView) findViewById(R.id.tvRegister);

        Toasty.Config.getInstance().apply();

        // Cek session login jika TRUE maka langsung buka LoginActivity
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.trim().length() > 0 && password.trim().length() > 0) {
                    ...
                    Toasty.error(LoginActivity.this,"Kolom tidak boleh kosong", Toast.LENGTH_SHORT,true).show();
                }
            }
        });
    ...
    private void checkLogin(final String username, final String password) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Toasty.success(getApplicationContext(), jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG,true).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toasty.error(getApplicationContext(), "Gagal Terhubung Ke Server", Toast.LENGTH_LONG,true).show();
