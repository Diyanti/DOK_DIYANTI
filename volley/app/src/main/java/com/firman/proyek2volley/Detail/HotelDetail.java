...
public class HotelDetail extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strImage = getIntent().getExtras().getString("hotel_image");
        String strTitle = getIntent().getExtras().getString("hotel_title");
        String strDesc = getIntent().getExtras().getString("hotel_desc");
