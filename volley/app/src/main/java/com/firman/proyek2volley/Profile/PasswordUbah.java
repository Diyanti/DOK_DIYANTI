package com.firman.proyek2volley.Profile;
        ...
        final StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success==1){
                        Toasty.success(PasswordUbah.this,jsonObject.getString(TAG_MESSAGE), Toast.LENGTH_LONG,true).show();
                        passlama.setText("");
                        passbaru.setText("");
                        passconfirm.setText("");
                    }else{
                        Toasty.error(PasswordUbah.this,jsonObject.getString(TAG_MESSAGE), Toast.LENGTH_LONG,true).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                if(error != null){
                    ...
                    Toasty.error(getApplicationContext(), "Ada kesalahan..", Toast.LENGTH_LONG,true).show();
                }
            }
        }){
            @Override
