...
public class RestoranDetail extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strImage = getIntent().getExtras().getString("restoran_image");
        String strTitle = getIntent().getExtras().getString("restoran_title");
        String strDesc = getIntent().getExtras().getString("restoran_desc");
