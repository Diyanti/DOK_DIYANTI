            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Toasty.success(ProfileUbah.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG,true).show();

                        Intent intent = new Intent(ProfileUbah.this,ProfileActivity.class);
                        intent.putExtra(TAG_ID,id);
                        startActivity(intent);
                    } else {
                        Toasty.error(ProfileUbah.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG,true).show();
                    }
                } catch (JSONException e) {
                    // JSON error
                    e.printStackTrace();
