...
public class BudayaDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strImage = getIntent().getExtras().getString("budaya_image");
        String strTitle = getIntent().getExtras().getString("budaya_title");
        String strDesc = getIntent().getExtras().getString("budaya_desc");
