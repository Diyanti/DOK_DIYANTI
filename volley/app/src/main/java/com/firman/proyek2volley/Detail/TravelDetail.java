...
public class TravelDetail extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strImage = getIntent().getExtras().getString("travel_image");
        String strTitle = getIntent().getExtras().getString("travel_title");
        String strDesc = getIntent().getExtras().getString("travel_desc");
