...
public class KulinerDetail extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strImage = getIntent().getExtras().getString("kuliner_image");
        String strTitle = getIntent().getExtras().getString("kuliner_title");
        String strDesc = getIntent().getExtras().getString("kuliner_desc");
