...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="kegiatan.php"><em class="fa fa-calendar">&nbsp;</em> Kegiatan</a></li>
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href="tambah_kegiatan.php"><button type="button" class="pull-left btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah</button></a>
					</div>
								...
								<table id="ngoding" class="table table-striped table-bordered">
							        ...
							        <tbody>
							            ...
							            <tr>
                                            ...
                                            <td><img src="image/kegiatan/<?php echo $data['gambar']; ?>" border="0" style="height: 150px;width: 200px"/></td>
                                            <td><a href="edit_kegiatan.php?id_kegiatan=<?=$data['id_kegiatan']?>"><button class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Edit</button></a>
                        					<a href="delete_kegiatan.php?id_kegiatan=<?=$data['id_kegiatan']?>"onclick="return confirm('Yakin akan dihapus ?');"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Hapus</button></a></td>
							            </tr>
							            <?php
					                    	}
					                    ?>
