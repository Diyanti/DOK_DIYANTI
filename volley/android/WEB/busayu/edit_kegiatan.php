            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?php
                            include "koneksi.php";
                            $data_edit = mysqli_query($con,"SELECT * FROM kegiatan WHERE id_kegiatan='".$_GET['id_kegiatan']."'");
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row" style="margin-top: 15px">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="text" name="tanggal"  id="tanggal" value="<?php echo $row['tanggal']?>" /></input>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="text" name="tempat" value="<?php echo $row['tempat']?>" /></input>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-2">
                        ...
                        <?php
                          if(isset($_POST['simpan'])){
                                 $update = mysqli_query($con,"UPDATE kegiatan SET nama='".$_POST['nama']."',tanggal='".$_POST['tanggal']."',tempat='".$_POST['tempat']."',deskripsi='".$_POST['deskripsi']."',gambar='".$_POST['gambar']."' WHERE id_kegiatan='".$_GET['id_kegiatan']."'");
                                 if($update){
                                       ...
                                       echo "<meta http-equiv='refresh' content='1 url=edit_kegiatan.php'>";
                                 }
                          }
                        ?>
                        </div>
