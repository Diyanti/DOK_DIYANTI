			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href="tambah_travel.php"><button type="button" class="pull-left btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah</button></a>
					</div>
						...
						<div class="canvas-wrapper">
							<div class="table-responsive">
								<table id="ngoding" class="table table-striped table-bordered">
							        ...
							        <tbody>
							        	<?php
					                        $sql = mysqli_query($con, "SELECT * from pariwisata WHERE id_jenis='3'");
					                        while ($data = mysqli_fetch_array($sql)){
					                    ?>
							            <tr>
							                <td><?php echo $data['nama'];?></td>
                                            <td><?php echo $data['deskripsi'];?></td>
                                            <td><img src="image/travel/<?php echo $data['gambar']; ?>" border="0" style="height: 150px;width: 200px"/></td>
                                            <td><a href="edit_travel.php?id_pariwisata=<?=$data['id_pariwisata']?>"><button class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Edit</button></a>
                        					<a href="delete_travel.php?id_pariwisata=<?=$data['id_pariwisata']?>"onclick="return confirm('Yakin akan dihapus ?');"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Hapus</button></a></td>
							            </tr>
							            <?php
					                    	}
					                    ?>
