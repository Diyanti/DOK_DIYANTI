...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Edit Wisata Buatan</h1>
            </div>
        </div><!--/.row-->
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?php
                            include "koneksi.php";
                            $data_edit = mysqli_query($con,"SELECT * FROM pariwisata WHERE id_pariwisata='".$_GET['id_pariwisata']."'");
                        ...
                        <?php
                          if(isset($_POST['edit'])){
                                 $update = mysqli_query($con,"UPDATE pariwisata SET nama='".$_POST['nama']."',deskripsi='".$_POST['deskripsi']."',gambar='".$_POST['gambar']."' WHERE id_pariwisata='".$_GET['id_pariwisata']."'");
                                 if($update){
                                       echo "<script>alert('Data Telah Diupdate')</script>";
                                       echo "<meta http-equiv='refresh' content='1 url=wisata_buatan.php'>";

                                 }else{
                                       echo "<script>alert('Data Gagal Diupdate')</script>";
                                       echo "<meta http-equiv='refresh' content='1 url=edit_wisata_alam.php'>";
                                 }
                          }
                        ?>
                        </div>
